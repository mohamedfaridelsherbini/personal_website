...
object HeroSectionComponent {
    ...
    fun append(builder: StringBuilder) {
        ...
        builder.appendLine("                    <p class=\"hero-subtitle\">Senior Android Engineer blending Kotlin, Swift, and automation to ship maintainable products that scale globally. I design architecture, pipelines, and UX together so regulated journeys stay fast, secure, and delightful.</p>")
        builder.appendLine("                    <ul class=\"hero-highlight-list\">")
        builder.appendLine("                        <li>Composable Android & KMP architectures rolled out across multi-brand platforms</li>")
        ...
        builder.appendLine("                        <a href=\"/static/files/Mohamed_ElSherbini_Resume.pdf\" class=\"secondary-button\" target=\"_blank\" rel=\"noopener\">Download résumé</a>")
        builder.appendLine("                    </div>")
        ...
        builder.appendLine("                        <p>Composable design systems, real-time observability, and battle-tested release trains keep every build stable under neon lights.</p>")
        ...
        builder.appendLine("                            <li>Automation frameworks (Selenium, Appium) powering shared Android/iOS pipelines</li>")
        builder.appendLine("                            <li>Security reviews covering encryption, biometric flows, and fintech compliance</li>")
        builder.appendLine("                        </ul>")
