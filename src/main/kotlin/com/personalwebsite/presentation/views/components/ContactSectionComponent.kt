...
object ContactSectionComponent {
    ...
    fun append(builder: StringBuilder, personalInfo: PersonalInfo, languages: List<Language>) {
        ...
        builder.appendLine("                <p class=\"section-subtitle\">Tell me about the Android platform you’re scaling, the audit you need, or the release train that keeps wobbling. I’ll get back within 24 hours.</p>")
        ...
        builder.appendLine("                    <a href=\"${personalInfo.linkedin}\" target=\"_blank\" rel=\"noopener\" class=\"contact-item\">")
        ...
        builder.appendLine("                    </a>")
        builder.appendLine("                    <a href=\"${personalInfo.github}\" target=\"_blank\" rel=\"noopener\" class=\"contact-item\">")
