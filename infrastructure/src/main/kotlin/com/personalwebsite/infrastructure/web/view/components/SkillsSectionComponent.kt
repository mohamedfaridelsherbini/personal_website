...
object SkillsSectionComponent {
    ...
    fun append(builder: StringBuilder, skills: List<Skill>) {
        ...
        builder.appendLine("                <p class=\"section-subtitle\">Tooling and languages I reach for when blueprinting performant, future-proof Android ecosystems.</p>")
