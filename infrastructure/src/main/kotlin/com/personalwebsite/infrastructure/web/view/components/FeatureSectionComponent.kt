...
object FeatureSectionComponent {
    fun append(builder: StringBuilder) {
        ...
        builder.appendLine(
            "            <p class=\"section-subtitle\">Composable architecture, end-to-end automation, and fintech reliability are the pillars behind every engagement I take on.</p>",
        )
        ...
        builder.appendLine(
            "                    <p>Radically modular Kotlin base layers, sealed contracts, and Compose-first UI kits so every squad ships independently without breaking the core system.</p>",
        )
        builder.appendLine("                </div>")
        builder.appendLine("                <div class=\"feature cluster-card\">")
        ...
        builder.appendLine(
            "                    <p>Cross-platform UI automation frameworks (Selenium, Appium) wired into Jenkins, Docker, and analytics stacks so release trains stay green and insights stay live.</p>",
        )
        builder.appendLine("                </div>")
        builder.appendLine("                <div class=\"feature cluster-card\">")
        builder.appendLine("                    <div class=\"feature-icon\">🔒</div>")
        ...
        builder.appendLine(
            "                    <p>Reliability, performance, and security-first mobile experiences for millions of users, built into every architecture decision, test, and deployment.</p>",
        )
        builder.appendLine("                </div>")
        builder.appendLine("            </div>")
