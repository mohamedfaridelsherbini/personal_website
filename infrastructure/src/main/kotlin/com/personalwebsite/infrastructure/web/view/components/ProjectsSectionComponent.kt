...
object ProjectsSectionComponent {
    ...
    fun append(builder: StringBuilder, projects: List<PersonalProject>) {
        ...
        builder.appendLine("                <p class=\"section-subtitle\">A blend of flagship launches, automation frameworks, and open source experiments that showcase architecture, AI, and platform integration work.</p>")
