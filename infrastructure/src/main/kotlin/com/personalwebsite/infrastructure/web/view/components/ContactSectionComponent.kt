...
object ContactSectionComponent {
    fun append(
        ...
        builder.appendLine("                        </div>")
        builder.appendLine(
            "                        <p class=\"contact-description\">Fastest path for briefs, contracts, and support requests.</p>",
        )
        builder.appendLine("                        <span class=\"contact-action\">Send Message</span>")
        builder.appendLine("                    </a>")
        builder.appendLine("                    ")
        builder.appendLine(
            "                    <a href=\"${personalInfo.linkedin}\" target=\"_blank\" rel=\"noopener\" class=\"contact-card\">",
        )
        builder.appendLine("                        <div class=\"contact-header\">")
        builder.appendLine("                            <div class=\"contact-icon\">")
        builder.appendLine(
        ...
        builder.appendLine("                        </div>")
        builder.appendLine(
            "                        <p class=\"contact-description\">Follow product drops, speaking gigs, and fintech notes.</p>",
        )
        builder.appendLine("                        <span class=\"contact-action\">Connect</span>")
        builder.appendLine("                    </a>")
        builder.appendLine("                    ")
        builder.appendLine(
            "                    <a href=\"${personalInfo.github}\" target=\"_blank\" rel=\"noopener\" class=\"contact-card\">",
        )
        builder.appendLine("                        <div class=\"contact-header\">")
        builder.appendLine("                            <div class=\"contact-icon\">")
        builder.appendLine(
        ...
        builder.appendLine("                        </div>")
        builder.appendLine(
            "                        <p class=\"contact-description\">Inspect OSS libraries, experiments, and CI templates.</p>",
        )
